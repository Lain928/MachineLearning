...
class UserBasedCF():
    ...
    def get_dataset(self, filename, pivot=0.75):
        ...
        for line in self.load_file(filename):
            user, movie, rating, timestamp = line.split(",") # 分隔符为","
    ...
    def evaluate(self):
        ...
        for i, user, in enumerate(self.trainSet):
            ...
            rec_movies = self.recommend(user) #得出与user用户最为接近的10个电影推荐
            # print(rec_movies) # 给用户推荐的10个电影
